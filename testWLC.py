...
print '    Sample size: n = ' + str(ns) + ' samples, labeled in ',
print str(ns/pool_size) + ' batches with ' + str(pool_size) + ' samples each.'
print '    Data dimensión = ' + str(X.shape[1])
...
print 'Evaluating random sampling...'
ALrandom = al.ActiveLearner('random', n_classes=n_classes)
